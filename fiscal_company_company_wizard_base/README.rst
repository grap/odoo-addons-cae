...
.. |badge3| image:: https://img.shields.io/badge/github-odoo-cae%2Fodoo--addons--cae-lightgray.png?logo=github
    :target: https://github.com/odoo-cae/odoo-addons-cae/tree/12.0/fiscal_company_company_wizard_base
...
`feedback <https://github.com/odoo-cae/odoo-addons-cae/issues/new?body=module:%20fiscal_company_company_wizard_base%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `odoo-cae/odoo-addons-cae <https://github.com/odoo-cae/odoo-addons-cae/tree/12.0/fiscal_company_company_wizard_base>`_ project on GitHub.
