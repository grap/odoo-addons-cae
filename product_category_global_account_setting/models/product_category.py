...
class ProductCategory(models.Model):
    ...
    global_property_account_expense_categ = fields.Char(
        string="Expense Account Code")

    global_property_account_income_categ = fields.Char(
        string="Income Account Code")
    ...
    def propagate_global_account_properties_recursive(self, field_names):
        ...
        for field_name in field_names:
            for category in self:
                companies = ResCompany.with_context(
                ...
                childs.write({
                    field_name: getattr(category, field_name),
                })
